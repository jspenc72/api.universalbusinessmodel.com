...
$sqlins = "INSERT INTO ubm_modelcreationsuite_heirarchy_object_antiSolipsism_UUID (legal_entity_id, model_id, position_id, jobDescription_id, policy_id, procedure_id, step_id, task_id, created_by) VALUES ('0','0',$v3,'0','0','0','0','0',$v5)";
...
//5. Now INSERT the links to all the ancestors of the JD_UUID into the Closure table so has a tie to all ojects above it.
			...
			if ($conn -> query($sqlins3) === false) {
				...
				echo $_GET['callback'] . '(' . "{'message' : 'Requested Position $v3 was created successfully and added to positionId $v4 !'}" . ')';
			}		
	}
}
